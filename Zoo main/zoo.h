...
//    Searches and chaneges
    void change(int number,string sex,string name,int how,zoo &obj){
        if(this->number==number){
            ...
            next->change(number,sex,name,how,obj);
        }
    }
    void change(int number,string animal,string sex,string name,double price,int how,zoo &obj){
        if(this->number==number){
            cout<<this->number<<") "<<this->animal<<endl<<this->sex<<endl<<this->name<<endl<<this->price<<endl<<this->how<<endl<<price_how<<endl<<endl;
            this->animal=animal;
            this->sex=sex;
            this->name=name;
            this->price=price;
            ...
            next->change(number,animal,sex,name,price,how,obj);
        }
    }
    void change(int number,double price,zoo &obj){
        if(this->number==number){
...
//    Copies the values of another object
    ...
    void copy(int number,string &animal,string &sex,string &name,double &price,int &how,zoo &obj){
        if(this->number==number){
            animal=this->animal;
            sex=this->sex;
            name=this->name;
            ...
            next->copy(number,animal,sex,name,price,how,obj);
        }
    }
...
//    For method change and other methods check
    ...
    bool search_changes(int number){
        if(next){
            if(this->number==number){
                return true;
            }
